...
# Note: IMGUI_DISABLE_OBSOLETE_FUNCTIONS removed for 1.92.x compatibility
# Many APIs we use (Build, GetTexData*, SetTexID, IsBuilt, glyph ranges) are now under obsolete guard
